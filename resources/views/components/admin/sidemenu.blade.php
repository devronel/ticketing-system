<div x-init="currentUrl = window.location.pathname">
    ...
    <div class="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
      <div class="flex-1 flex flex-col min-h-0 bg-teal-500">
        <div class="flex items-center justify-center h-auto flex-shrink-0 pt-3 px-4">
          <img class=" w-28 aspect-square" src="{{ asset('img/help-central-logo.png') }}" alt="">
        </div>
        <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                ...
                @else
                    <a href="{{ route('agent-dashboard.index') }}" class="{{ request()->routeIs('agent-dashboard.index') ? 'bg-teal-700 text-gray-100' : 'text-gray-100 hover:bg-teal-700' }} group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        <svg class=" mr-3 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                        Agent Dashboard
                ...
                @can('user.view')
                    <div x-data="{ openUserManagement: false }">
                        ...
                        <div x-show="openUserManagement || currentUrl.startsWith('/user-management')" class=" ml-4 mt-2 flex flex-col gap-1">
                            @can('user.view')
                                <a href="{{ route('user-management.index') }}" class="{{ request()->routeIs('user-management.index') ? 'bg-teal-700 text-gray-100' : 'text-gray-100 hover:bg-teal-700' }} hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class=" group-hover:text-white mr-3 flex-shrink-0 size-5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                                    </svg>                      
                                    Users
                                </a>
                            @endcan
                            @can('role.view')
                                <a href="{{ route('user-management.role.index') }}" class="{{ request()->routeIs('user-management.role.index') || request()->routeIs('user-management.permission.index') ? 'bg-teal-700 text-gray-100' : 'text-gray-100 hover:bg-teal-700' }} hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="group-hover:text-white mr-3 flex-shrink-0 size-5">
                            ...
                            @endcan
                            @can('department.view')
                                <a href="{{ route('user-management.department.index') }}" class="{{ request()->routeIs('user-management.department.index') ? 'bg-teal-700 text-gray-100' : 'text-gray-100 hover:bg-teal-700' }} hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="group-hover:text-white mr-3 flex-shrink-0 h-6 w-6">
                ...
                @can('reference.view')
                    <div x-data="{ openSettings: false }">
                        ...
                        <div x-show="openSettings || currentUrl.startsWith('/reference')" class=" ml-4 mt-2 flex flex-col gap-1">
                            <a href="{{ route('reference.priority') }}" class="{{ request()->routeIs('reference.priority') ? 'bg-teal-700 text-gray-100' : 'text-gray-100 hover:bg-teal-700' }} hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="group-hover:text-white mr-3 flex-shrink-0 size-5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.042 21.672 13.684 16.6m0 0-2.51 2.225.569-9.47 5.227 7.917-3.286-.672Zm-7.518-.267A8.25 8.25 0 1 1 20.25 10.5M8.288 14.212A5.25 5.25 0 1 1 17.25 10.5" />
                                </svg>                                                                                               
                                Priorities
                            </a>
                            <a href="{{ route('reference.status') }}" class="{{ request()->routeIs('reference.status') ? 'bg-teal-700 text-gray-100' : 'text-gray-100 hover:bg-teal-700' }} hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="group-hover:text-white mr-3 flex-shrink-0 size-5">
