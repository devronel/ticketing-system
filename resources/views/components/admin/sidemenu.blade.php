      ...
      <div class="flex-1 flex flex-col min-h-0 bg-teal-500">
        ...
        <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                ...
                @can('view-user')
                    <div x-data="{ openUserManagement: false }">
                        ...
                        <div x-show="openUserManagement || currentUrl.startsWith('/user-management')" class=" ml-4 mt-2 flex flex-col gap-1">
                            ...
                            <a href="{{ route('user-management.roles') }}" class="{{ request()->routeIs('user-management.roles') ? 'bg-teal-700 text-gray-100' : 'text-gray-100 hover:bg-teal-700' }} hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="group-hover:text-white mr-3 flex-shrink-0 size-5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" />
                                </svg>                                                                                                                                                        
                                Roles
                            </a>
                            <a href="{{ route('user-management.department') }}" class="{{ request()->routeIs('user-management.department') ? 'bg-teal-700 text-gray-100' : 'text-gray-100 hover:bg-teal-700' }} hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="group-hover:text-white mr-3 flex-shrink-0 h-6 w-6">
                ...
                @endcan
                {{-- <a href="{{ route('department.index') }}" class="{{ request()->routeIs('department.index') ? 'bg-teal-700 text-gray-100' : 'text-gray-100 hover:bg-teal-700' }} hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="group-hover:text-white mr-3 flex-shrink-0 h-6 w-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" />
                      </svg>                                           
                    Department
