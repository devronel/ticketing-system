<div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
    <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
        ...
        <div class="px-4 text-gray-700">
            <h3 class="text-sm tracking-wider">Total Ticket</h3>
            <p class="text-3xl">{{ $countTicket }}</p>
        </div>
    </div>
    <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
        ...
        <div class="px-4 text-gray-700">
            ...
            <p class="text-3xl">{{ $countUser['total_customers'] }}</p>
        </div>
    </div>
    <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
        ...
        <div class="px-4 text-gray-700">
            <h3 class="text-sm tracking-wider">Total Agent/Support</h3>
            <p class="text-3xl">{{ $countUser['total_agents'] }}</p>
        </div>
    </div>
    <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
