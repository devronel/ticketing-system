                              ...
                              @forelse ($roles as $role)
                                  <tr class="bg-white border-b border-gray-200 divide-x divide-gray-200">
                                      ...
                                      <td class="px-4 py-1 whitespace-nowrap text-sm text-gray-500">
                                          <div>
                                            @can('role.edit')
                                                <button wire:click="fetchEdit({{ $role->id }})" type="button" class="inline-flex items-center gap-1 p-1 border border-transparent shadow-sm text-xs leading-4 font-medium rounded text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
